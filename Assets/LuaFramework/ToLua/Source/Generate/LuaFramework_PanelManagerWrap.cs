...
public class LuaFramework_PanelManagerWrap
{
	...
	{
		L.BeginClass(typeof(LuaFramework.PanelManager), typeof(LuaFramework.Manager));
		L.RegFunction("CreatePanelBySync", CreatePanelBySync);
	...
	static int CreatePanelBySync(IntPtr L)
	{
		try
		{
			...
			UnityEngine.GameObject o = obj.CreatePanelBySync(arg0, arg1);
