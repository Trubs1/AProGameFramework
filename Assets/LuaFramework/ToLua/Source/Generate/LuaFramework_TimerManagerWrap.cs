...
public class LuaFramework_TimerManagerWrap
{
	...
	{
		L.BeginClass(typeof(LuaFramework.TimerManager), typeof(LuaFramework.Manager));
		...
		L.RegFunction("CheckTimerEvent", CheckTimerEvent);
	...
	static int AddTimerEvent(IntPtr L)
	{
		try
		{
			...
			LuaFramework.TimerInfo arg1 = (LuaFramework.TimerInfo)ToLua.CheckObject<LuaFramework.TimerInfo>(L, 3);
			obj.AddTimerEvent(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int CheckTimerEvent(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			LuaFramework.TimerManager obj = (LuaFramework.TimerManager)ToLua.CheckObject<LuaFramework.TimerManager>(L, 1);
			string arg0 = ToLua.CheckString(L, 2);
			bool o = obj.CheckTimerEvent(arg0);
