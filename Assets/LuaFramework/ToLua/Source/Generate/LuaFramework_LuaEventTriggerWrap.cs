...
public class LuaFramework_LuaEventTriggerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(LuaFramework.LuaEventTrigger), typeof(UnityEngine.EventSystems.EventTrigger));
	...
	static int Initiate(IntPtr L)
	{
		try
		{
			...
			LuaFramework.LuaEventTrigger obj = (LuaFramework.LuaEventTrigger)ToLua.CheckObject<LuaFramework.LuaEventTrigger>(L, 1);
