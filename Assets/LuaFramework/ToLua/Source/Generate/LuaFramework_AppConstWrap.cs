...
public class LuaFramework_AppConstWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("luaDirs", get_luaDirs, set_luaDirs);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_luaDirs(IntPtr L)
	{
		try
		{
			ToLua.Push(L, LuaFramework.AppConst.luaDirs);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_luaDirs(IntPtr L)
	{
		try
		{
			string[] arg0 = ToLua.CheckStringArray(L, 2);
			LuaFramework.AppConst.luaDirs = arg0;
			return 0;
		}
		catch (Exception e)
		{
